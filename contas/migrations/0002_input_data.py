...
class Migration(migrations.Migration):
	...
	operations = [
			...
			migrations.RunSQL(
					sql=[
							("INSERT INTO contas_classificacaopagar (sigla, descricao) VALUES (%s, %s);",
							 ['AG', 'Água'])],
					reverse_sql=[
			...
			migrations.RunSQL(
					sql=[
							("INSERT INTO contas_formapagamento (sigla, descricao) VALUES (%s, %s);",
							 ['DI', 'Dinheiro'])],
					reverse_sql=[
			...
			migrations.RunSQL(
					sql=[
							("INSERT INTO contas_classificacaoreceber (sigla, descricao) VALUES (%s, %s);",
							 ['SE', 'Serviço prestado'])],
					reverse_sql=[
